**HAPIBI** – приложение для создания поздравлений с помощью ИИ: авторизация через ВКонтакте, просмотр списка друзей и их дней рождения, генерация поздравлений с учетом настроек (праздник, стиль).
