...
object ModuleApp {
    ...
    @Provides
    @Singleton
    fun provideRefreshTokenUseCase(socialNetworkRepository: SocialNetworkRepository): RefreshTokenUseCase {
        return RefreshTokenUseCaseImpl(socialNetworkRepository = socialNetworkRepository)
    }
